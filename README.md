...
- ⚖️ **고과냐 주식이냐** — 회의에서 딴짓하다 걸리면 고과가 깎이고, 60일마다 **인사평가**로 승진/경고/해고가 갈린다. 해고되면 월급 없는 **전업투자자** 인생.
- 🤫 **내부자 정보의 유혹** — 친한 동료가 은밀히 찔러주는 정보는 85% 잭팟. 하지만 3일 뒤 금감원 조사가 나오면 벌금에 고과 폭락. 받을 것인가, 말 것인가.
...
- 배속 1x/2x/4x, "다음 개장까지"·"하루 끝" 스킵. 30일마다 월급, 60일마다 **인사평가**(고과에 따라 승진 → 임원 / 경고 / 해고)
...
- 근무 인터랙션(하루가 멈추고 **진입 컷씬** 후 진행):
  - **회의** → 미니게임 5종(눈치 타이밍·연타·몰래 폰 보기·순서 기억·숫자 찾기). 성공 시 [동료와 장난(친밀도)] / [몰래 주식 30초] 선택. 걸리면 고과 -2, 집중하면 고과 +1
  - **담배타임 / 점심 / 커피 챗 / 회식** → 같이 가면 친밀도 + 종목 팁

### 인사고과 · 내부자 딜레마
- 고과 점수: 회의 집중 +1 / 딴짓 걸림 -2 / 내부자 적발 -5. 홈 자산 카드에 상시 표시
- **60일마다 인사평가**: 고과 +6↑ 승진(월급 인상), -4↓ 경고, 경고 2회 = **해고**
- 해고되면 월급·회사 인터랙션 소멸 — 전업투자자 루트로 계속 플레이
- **내부자 정보**: 친밀도 40+ 고신뢰 동료가 은밀히 제안 → 다음 날 85% 급등 공시(+26%) / 15% 헛소문. 3일 뒤 30% 확률 금감원 조사 → 총자산 15% 벌금 + 고과 -5

### 컷씬
- 재사용 컷씬 시스템(배경 + 대사 말풍선/내레이션 + 선택지, 탭 진행)
- 인터랙션 진입 장면(회의 소집·옥상 흡연장·커피·구내식당·회식, 대사 랜덤 변주) + 이벤트 컷씬(내부자 제안·금감원 조사·승진·경고·해고)
...
- [ ] **Phase 5** — 비주얼 강화: 컷씬 영상화(video_player), 아바타 아트 교체(캐릭터 시트), 효과음/BGM, 엔딩 시퀀스
